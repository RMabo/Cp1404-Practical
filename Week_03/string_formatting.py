...
print(f"{year} {name} for about ${cost}!")  # no formatting
print(f"{year} {name} for about ${cost:,.0f}!")  # rounds the cost to the nearest whole number
print(f"{year} {name} for about ${cost:,.2f}!")  # rounds the cost to the nearest 2 decimal places
...
# 100
# 150
for i in range(0, 151, 50):  # range(start, stop, step)
    print("{:>3}".format(i))  # right aligns the numbers in a column of width 3
